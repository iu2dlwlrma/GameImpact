...
namespace GameImpact.Input
{
    ...
    {
        /// <summary>在后台窗口的指定位置执行鼠标点击（使用 PostMessage）</summary>
        ...
        /// <summary>在前台窗口的指定位置执行鼠标点击（使用 SendInput）</summary>
        /// <param name="x">X坐标（客户区坐标）</param>
        /// <param name="y">Y坐标（客户区坐标）</param>
        /// <returns>是否成功</returns>
        ...
        /// <summary>移动鼠标到指定位置（屏幕坐标）</summary>
